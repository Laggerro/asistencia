<div class="modal fade" id="editarPreceptorModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 titulo_modal">Editar datos del Preceptor</h1>
                ...
                <form id="formularioPreceptorEdit" action="" method="POST" autocomplete="off">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn_add"
                            onclick="window.actualizarPreceptor(event)">
