<div class="modal fade" id="agregarCursoModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formularioCursoEdit" action="" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Horario ingreso (Ejemplo: 08:00)</label>
                        <input type="text" name="horaIn" id="horaIn" class="form-control" placeholder="07:00"
                            required />
                    </div>
